<?php 
$bdd = new PDO ('mysql:host=localhost;dbname=etrilabs;charset=utf8','root','');
     ...
     {   
        ...
        $age = htmlspecialchars($_POST['age']);
         ...
         if(in_array($file_extension,$extension_autorise)){
            ...
            $insert=$bdd->prepare('INSERT INTO exolabs(nom,prenom,age, name,file_url) VALUES(?,?,?,?,?)');
            $insert->execute(array($nom,$prenom,$age,$file_name,$file_dest)); 
            $erreur='votre enregistrement à été effectué'; 
...
<h1 class="wow fadeInUp" data-wow-delay="0.9s">.</h1>
        ...
        <div class="container py-5">
           ...
           <h1 class=" wow fadeInUp b-title fs-2" style="text-align:center; color:'white">Enregistrement des étudiants</h1>
            </div>
              ...
              <form  method="POST" action=""  enctype="multipart/form-data">
                  ...
                  <div class="field">
                     <label for="photo" class="form-label"> votre photos:</label> 
                     <div class="input-group mb-3">
